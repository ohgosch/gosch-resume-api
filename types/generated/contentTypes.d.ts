...
export interface ApiCoverLetterCoverLetter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    coverLetterContent: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      ...
      Schema.Attribute.DefaultTo<'remote'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSkeletonSkeleton extends Struct.SingleTypeSchema {
...
export interface ApiSkillsSectionSkillsSection extends Struct.SingleTypeSchema {
